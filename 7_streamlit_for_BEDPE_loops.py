...
if uploaded_file is not None:
    ...
    command = f"python https://github.com/truong128/HiC_3D_Genomics/blob/main/5_Parallel_Clustering_loops_from_bedpe.py {combined_file_path} {min_dist} {max_window} {min_number} {cluster_dist}"
